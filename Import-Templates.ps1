...
foreach ($template in $templates) {
	...
	# Issue templates
    Set-ADCSTemplateACL -DisplayName $templateName -Identity 'asd\domain users' -Enroll -AutoEnroll
...
Set-ADCSTemplateACL -DisplayName IP-ssl -Identity 'asd\domain admins' -Enroll -AutoEnroll
